...
export default function SignUpPage() {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    e.preventDefault();
    // Redirect to User Profile Dashboard after sign up
    setLocation("/User-Profile-Dashboard");
  };

  const handleGoogleSignIn = () => {
    // Redirect to User Profile Dashboard after Google sign in
    setLocation("/User-Profile-Dashboard");
  };
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-8">
          ...
          <Button
            ...
            variant="outline"
            className="w-full mt-4 border-2 border-gray-300 hover:bg-gray-50 py-3 rounded-lg font-semibold text-base flex items-center justify-center space-x-2"
          >
