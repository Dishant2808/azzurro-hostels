...
// Import the new Surry Hills Hotel Azzurro image
  ...
  return (
    <div className="font-inter bg-white min-h-screen">
      ...
      <div className="pt-32">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Azzurro Pod Hotels - Surry Hills
                </h1>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-600">
                  <div className="flex items-center space-x-1">
                    ...
                    <span>84 Flinders Street, Darling Harbour, NSW 2010</span>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Surry Hills offers an experience for visitors seeking a
                    memorable stay in Sydney's creative quarter. Visit the
                    trendy boutiques and artisan markets by day that showcase
                    local crafts and unique finds. Evening in Surry Hills comes
                    alive with an eclectic mix of wine bars, craft breweries,
                    and innovative dining venues.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-6">
                    For a taste of Surry Hills' artistic flair, explore the
                    bustling Crown Street with its vintage stores and indie
                    cafes. Unwind at one of the area's renowned rooftop bars or
                    sample the diverse culinary scene that ranges from authentic
                    ramen shops to modern Australian cuisine.
                  </p>
                </div>
                ...
                <Card className="mb-6">
                  <CardContent className="p-6">
                    <p className="text-gray-700 italic mb-4">
                      "Perfect location in the heart of Surry Hills! Walking
                      distance to amazing cafes, restaurants, and vintage shops.
                      The pod was clean and comfortable with great privacy
                      curtains. Staff was incredibly helpful and the shared
                      kitchen was well-equipped. Highly recommend for solo
        ...
        <section className="py-12">
          <AdvanceSearchAndResult selectedLocation="Surry Hills" />
        </section>
