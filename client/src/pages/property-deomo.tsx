...
import { 
  MapPin, Phone, Star, Wifi, Coffee, Train, Heart, Share2, 
  ChevronLeft, ChevronRight, AirVent, Heater, WifiIcon, 
  Tv, Utensils, Shirt, Bath, Wrench, Calendar, Users, Menu, Search, MessageCircle,
  Zap, Lightbulb, Eye, Bed
} from "lucide-react";
  ...
  return (
    <div className="font-inter bg-white min-h-screen">
      ...
      <section className="py-2">
        <div className="max-w-screen md:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Hotel Name and Rating */}
          <div className="flex flex-col-reverse md:flex-row gap-2 justify-between items-start mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Azzurro Pod Hotels - Potts Point</h1>
              <div className="flex items-center space-x-4 mb-4">
                <div className="flex items-center space-x-1">
                  {[1,2,3,4,5].map((star) => (
                    <Star key={star} className="h-5 w-5 text-yellow-400 fill-current" />
                  ))}
                  <span className="bg-blue-900 text-white px-2 py-1 rounded text-sm font-bold ml-2">9.0</span>
                </div>
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-600">
                <div className="flex items-center space-x-1">
                  ...
                  <span>141-143 Victoria Street, Potts Point, NSW 2011</span>
                </div>
                <span className="text-green-600 font-medium">Good Location</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                <img src={images[0]} alt="Main view" className="w-full h-20 object-cover rounded cursor-pointer hover:opacity-80" />
                <img src={images[1]} alt="Room view" className="w-full h-20 object-cover rounded cursor-pointer hover:opacity-80" />
                <img src={images[2]} alt="Common area" className="w-full h-20 object-cover rounded cursor-pointer hover:opacity-80" />
                <div className="relative bg-gray-100 rounded flex items-center justify-center h-20 cursor-pointer hover:bg-gray-200">
                  <span className="text-xs text-gray-600 font-medium">10+ photos</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Potts Point offers an experience for visitors seeking a memorable stay in Sydney. Visit the markets by day that offer local crafts and food. Evening in Potts Point come alive with city views and a wide selection of bars, restaurants, and nightclubs just along the main road.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
                  For a taste of Potts Point's vibrancy, head to PINA, a lively Latin American eatery known for its sizzling grills and infectious energy. Late, unwind at Salumeria, a charming wine bar boasting an extensive cheese and cured meat selection, perfect for a sophisticated evening.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <span className="text-xs">Privacy curtains next to the bed</span>
            </div>
            <div className="flex flex-col items-center space-y-2">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <span className="text-xs">Shared kitchen with kitchen equipment provided</span>
            </div>
            <div className="flex flex-col items-center space-y-2">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Guest who Stay here Loved</h2>
            ...
            <div>
              <div className="bg-gray-100 rounded-lg h-64 overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3312.7878!2d151.2242!3d-33.8697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12ae3e77a5cb11%3A0x2e4f9e0e7f8c9a5b!2s141%20Victoria%20St%2C%20Potts%20Point%20NSW%202011%2C%20Australia!5e0!3m2!1sen!2sau!4v1234567890123!5m2!1sen!2sau"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  ...
                  title="Azzurro Pod Hotel - Potts Point Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="py-12">
        <AdvanceSearchAndResult selectedLocation="Potts Point"/>
      </section>
