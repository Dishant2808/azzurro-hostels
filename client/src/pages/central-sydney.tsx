...
// Import the new Central Sydney Hotel Azzurro image
...
export default function CentralSydneyPage() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [sidebarOpen, setSidebarOpen] = useState(false);

  const images = [
    centralSydneyExterior,
  ...
  return (
    <div className="font-inter bg-white min-h-screen">
      ...
      <div className="pt-16">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Azzurro Pod Hotels - Central Sydney
                </h1>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-600">
                  <div className="flex items-center space-x-1">
                    ...
                    <span>90 Wentworth Avenue, Surry Hills, NSW 2010</span>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Central Sydney places you at the heart of Australia's
                    business capital, with unparalleled access to the Sydney
                    Opera House, Harbour Bridge, and Circular Quay. The bustling
                    CBD offers world-class shopping at Queen Victoria Building
                    and Pitt Street Mall, alongside premium dining and cultural
                    experiences.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Start your day with a harbor walk to the Royal Botanic
                    Gardens, explore the historic Rocks district with its
                    weekend markets, or catch a ferry to Manly Beach. The
                    convenient location puts major transport hubs, business
                    districts, and Sydney's most iconic attractions within
                    walking distance.
                  </p>
                </div>
        ...
        <section className="py-12">
          <AdvanceSearchAndResult selectedLocation="Central Sydney" />
        </section>
