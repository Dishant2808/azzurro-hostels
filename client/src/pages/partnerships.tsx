...
import partnershipsHeroImage from "@assets/image_1754888602233.png";
import { 
  Users, 
  Building, 
  MapPin,
...
const benefits = [
  {
    ...
    title: 'Prime Sydney Location',
    description: 'Easy access to attractions, dining, and public transport.'
  },
  {
    icon: <Users className="h-6 w-6 text-orange-600" />,
    title: 'Diverse Guest Base',
    description: 'From solo travelers to large tour groups.'
  },
  {
    icon: <Handshake className="h-6 w-6 text-orange-600" />,
    title: 'Flexible Collaboration',
    description: 'Tailored packages, exclusive rates, and joint promotions.'
  },
  {
    icon: <Building className="h-6 w-6 text-orange-600" />,
    title: 'Authentic Experiences',
    description: 'Home-style meals, communal spaces, and a focus on community.'
  }
];
    ...
    <div className="font-inter bg-white min-h-screen">
      ...
      <div className="pt-16 bg-gray-50 min-h-screen">
        ...
        <section 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${partnershipsHeroImage})`,
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <div className="space-y-6 text-lg text-gray-700">
              <p>
                At Azzurro Pod Hotels, we believe travel should be comfortable, social, and affordable — all without compromising on quality.
              </p>
              <p>
                From our home-cooked meals to our modern pod-style beds, we've built a space where guests from around the world feel right at home in Sydney.
              </p>
              <p>
                We're always looking for like-minded partners who share our passion for hospitality, community, and memorable guest experiences.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                We'd love to hear your ideas and explore how we can work together.<br />
                Simply fill out the form below, and our team will get back to you within 1–2 business days.
              </p>
            </div>

            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-center">Partnership Inquiry</CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="w-full"
                      placeholder="e.g., Group booking partnership, Content collaboration, etc."
                    />
                  </div>
