...
export default function PottsPointPage() {
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Azzurro Pod Hotels - Potts Point
                </h1>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Potts Point offers an experience for visitors seeking a
                    memorable stay in Sydney. Visit the markets by day that
                    offer local crafts and food. Evening in Potts Point come
                    alive with city views and a wide selection of bars,
                    restaurants, and nightclubs just along the main road.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-6">
                    For a taste of Potts Point's vibrancy, head to PINA, a
                    lively Latin American eatery known for its sizzling grills
                    and infectious energy. Late, unwind at Salumeria, a charming
                    wine bar boasting an extensive cheese and cured meat
                    selection, perfect for a sophisticated evening.
                  </p>
                </div>
        ...
        <footer className="azzurro-navy-bg text-white py-12">
          <div className="content-centered px-4">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-x-8 gap-y-8 mb-12">
              ...
              {/* Explore Column */}
              <div>
                <h3 className="text-15 font-semibold text-white mb-4">
                  Explore
                </h3>
